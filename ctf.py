        ...
        try:
            ...
            if last_port == -1:
                ...
                if diff ==  STD_DIFF + current_chunk:
                    current_guess[current_chunk] += 1
                    last_port = client_port
                elif diff == (STD_DIFF + current_chunk + 1):
                    current_confidence += 1
                    if current_confidence == CONFIDENCE:
                        print 'Chunk %s = %s looks good' % (current_chunk, current_guess[current_chunk])
                        current_confidence = 0
                        current_chunk += 1
            ...
            if current_guess[current_chunk] > 999:
                print 'Unexpected again!!!'
                clean_exit(p)
